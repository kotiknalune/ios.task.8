...
- (void)headLineart:(CGColorRef)lineColor secondColor:(CGColorRef)secondLineColor thirdColor:(CGColorRef)thirdLineColor lineWidth:(CGFloat)lineWidth duration:(CGFloat)duration
{
    ...
    animateLayer2.lineCap = kCALineCapRound;
    animateLayer2.lineJoin = kCALineJoinBevel;
    animateLayer2.fillColor = [[UIColor clearColor] CGColor];
    ...
    animateLayer3.lineCap = kCALineCapRound;
    animateLayer3.lineJoin = kCALineJoinBevel;
    animateLayer3.fillColor = [[UIColor clearColor] CGColor];
